...
from langchain_openai import ChatOpenAI  # Updated OpenAI integration
...
def generate_rag_answer(question):
    ...
    try:
        ...
        # Updated to use ChatOpenAI instead of LangchainOpenAI
        llm = ChatOpenAI(
...
def perform_course_generation():
    ...
    try:
        ...
        # Updated model selection to use valid models
        model_selection = st.session_state.get('selected_model', 'gpt-3.5-turbo')
...
# Updated model options to use current valid models
